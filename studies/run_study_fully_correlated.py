...
def run_job(method, source_dataset, target_dataset, training_seed):
    ...
    dataset_spec = utils.create_merged_dataset_config(source_dataset, target_dataset, repo_dir, overwrite=True)
...
if __name__ == '__main__':
    ...
    target_dataset_list = ['color_animal_fully_correlated']
    method_list = ['default/FactorSRC', 'default/FactorSRC-CI', 'default/FactorSRC-IL']
